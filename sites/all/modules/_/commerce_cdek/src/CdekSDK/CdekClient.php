...
class CdekClient {
  ...
  //индекс города-отправителя
  private $senderCityPostCode;
  //индекс города-получателя
   ...
   * Город-отправитель
   *
   * @param string $zipcode города
   */
  public function setSenderCityPostCode($zipcode) {
    if(strlen($zipcode) != 6) {
      throw new Exception("Неправильно задан индекс города-отправитель.");
    }
    $this->senderCityPostCode = $zipcode;
  }
   ...
   * @param string $zipcode города
   */
  public function setReceiverCityPostCode($zipcode) {
    if(strlen($zipcode) != 6) {
      throw new Exception("Неправильно задан индекс города-получатель.");
    }
    $this->receiverCityPostCode = $zipcode;
  }
