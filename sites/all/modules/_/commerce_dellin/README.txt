This module provides Delovie Linii shipping quotes for Drupal Commerce.
...
------------
  ...
  * A Delovie Linii Developer Program API key. See [1] for instructions (follow
    steps 1 to 3).
...
[2] http://YOURSITE/?q=admin/commerce/config/shipping/methods/dellin/edit
