This module provides RussianPost shipping quotes for Drupal Commerce.
...
------------
  ...
  * A RussianPost Developer Program API key. See [1] for instructions (follow
    steps 1 to 3).
...
[2] http://YOURSITE/?q=admin/commerce/config/shipping/methods/russianpost/edit
